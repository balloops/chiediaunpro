    ...
    <div className="min-h-screen flex items-center justify-center p-4 lg:p-8 bg-white">
      <div className="w-full max-w-[1250px] min-h-[700px] bg-white rounded-[32px] overflow-hidden flex flex-col lg:flex-row shadow-sm border border-slate-100">
        ...
        <div className="lg:w-5/12 bg-indigo-600 p-12 text-white flex flex-col justify-between relative overflow-hidden m-2 rounded-[24px]">
           ...
           <div className="relative z-10 mt-12 bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/10 max-w-xs">
              <div className="flex items-center space-x-4">
                 <div className="flex -space-x-3">
                    {[1,2,3].map(i => <img key={i} src={`https://picsum.photos/40/40?random=${i}`} className="w-10 h-10 rounded-full border-2 border-indigo-500 object-cover" />)}
                 </div>
                 <div>
                    <div className="text-[10px] font-black uppercase tracking-widest opacity-70 mb-0.5">SCELTO DA 10K+ UTENTI</div>
                    <div className="text-sm font-medium italic">"Il miglior strumento per scalare la mia agenzia."</div>
                 </div>
              </div>
           </div>
        </div>
